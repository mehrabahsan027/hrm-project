...
export default function EmployeeTableRow({ employee }) {
    ...
    const {employeeId, employeeName, duration, startTime, endTime, dueHours, department, project, notes} = employee;
  ...
  return (
     <tr className="border-b border-gray-200 hover:bg-gray-50 whitespace-nowrap">
            ...
            <td className="p-3 px-8">{duration} hr</td>
            <td className="p-3 px-8">{startTime} - {endTime}</td>
            <td className="p-3 px-8">{dueHours} hr</td>
